...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleResourceNotFound(ResourceNotFoundException exception){
        ApiError apiError=ApiError.builder().status(HttpStatus.NOT_FOUND).message("Resource not found")
                .build();
    ...
    public ResponseEntity<ApiResponse<?>> handleMethodArguementNotValid(MethodArgumentNotValidException exception){
